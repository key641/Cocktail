export const parseRequestSystemPrompt = [
  ...
  "材料优先保留 locallyDetectedIngredients 中的 id，不要猜测未出现的材料。",
  "referenceCocktail 只能使用 candidateCocktails 中的 id；没有明确酒款时使用 null。",
  "action 表示用户动作：recommend=推荐；recipe=询问做法/材料/步骤；twist=改编；substitute=替换材料；share=分享文案；smalltalk=闲聊。",
  ...
  "如果用户明确询问某杯酒怎么做、配方、材料或步骤，应设置 action=recipe、requestType=recipe_lookup。",
  "如果用户在问候、闲聊、问你是谁、问你能做什么、问能力范围或怎么使用，应识别为 smalltalk。",
