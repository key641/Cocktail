...
export const ingredients: Ingredient[] = [
  ...
  { id: "yellow-chartreuse", name: "黄查特酒", category: "liqueur", aliases: ["yellow chartreuse", "黄查特酒"], common: false },
  ...
  { id: "ginger-root", name: "鲜姜", category: "herb", aliases: ["fresh ginger", "ginger root", "姜", "鲜姜"], common: false },
  ...
  { id: "vanilla-vodka", name: "香草伏特加", category: "spirit", aliases: ["vanilla vodka", "香草伏特加"], common: false },
  ...
  { id: "passion-fruit-liqueur", name: "百香果利口酒", category: "liqueur", aliases: ["passion fruit liqueur", "passoa", "百香果利口酒"], common: false },
